...
<div class="position-absolute top-50 start-50 translate-middle">
    <h1 class="text-center p-3 text-light">ENTER YOUR PAN CARD NUMBER AND YOUR PIN </h1>
  ...
  <div class="mb-3">
    ...
    <div id="emailHelp" class="form-text text-light">We'll never share your PAN number with anyone else.</div>
  </div>
  <div class="mb-3">
  ...
  <button type="submit" class="btn btn-primary" name="withdrawl"><a href=check.php class="text-white">Login</a></button>
</form>
</div>
